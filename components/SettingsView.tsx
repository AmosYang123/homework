...
const SettingsView: React.FC<SettingsViewProps> = ({ settings, onUpdate, onClearData, onExport }) => {
  const updateField = (field: keyof AppSettings, value: any) => {
    onUpdate({ ...settings, [field]: value });
  };

  return (
    <div className="flex-1 h-full overflow-y-auto custom-scrollbar px-8 pt-16 pb-32 animate-fade-in">
      <div className="max-w-3xl mx-auto">
        <header className="mb-20 border-b border-border-primary pb-8">
        ...
        <div className="space-y-24">
          ...
          <footer className="pt-20 border-t border-border-primary opacity-30 text-center">
            <div className="text-[9px] font-bold uppercase tracking-[0.5em] text-text-secondary">A& Intelligence Engine Standard v1.0.0</div>
          </footer>
        </div>
      </div>
    </div>
